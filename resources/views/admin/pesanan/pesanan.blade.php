    ...
    <div class="card mb-4">
        ...
        <div class="card-header">
            {{-- @if (Auth::user()->role == 'admin') --}}
                <a href="{{url('admin/kategoriproduk/create')}}" class="btn btn-primary">Tambah Pesanan</a>
            {{-- @endif --}}
        </div>
        <div class="card-body">
            <table class="table table-bordered" id="datatablesSimple">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{-- @if (Auth::user()->role == 'admin') --}}
                            <a href=" {{url('/admin/produk/delete/'. $pes->id)}}">
                                <button type="button" class="btn btn-warning btn-sn" title="Edit Pesanan">
                                <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </button>
                            </a>
                            {{-- @endif --}}
                            <a href=" {{url('/admin/kategoriproduk/delete/'. $pes->id)}}">
